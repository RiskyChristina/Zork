...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[1, 0].Description = "This is a forrest, with trees in all directions around you.";                                                    // Forrest
            Rooms[1, 1].Description = "This is an open field west of a white house, with a boarded front door.";                                        // West of House
            Rooms[1, 2].Description = "You are behind the white house. In one corneer of the house there is a small window which is slightly ajar.";    // Behind House

            Rooms[2, 0].Description = "This is a dimly lit forrest, with large trees all around. To the east, there appears to be sunlight.";           // Dense Woods
            ...
            Rooms[2, 2].Description = "You are in a clearing, with a forrest surrounding you on the west and south.";                                   // Clearing
        }
